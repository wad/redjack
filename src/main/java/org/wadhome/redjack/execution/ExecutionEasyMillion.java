...
import org.wadhome.redjack.rules.TableRulesEasy;
...
class ExecutionEasyMillion extends Execution {

    public static void main(String... args) {
        new ExecutionEasyMillion().execute();
    }
    ...
    Casino execute() {
        ...
        TableRules tableRules = new TableRulesEasy();
