...
public class PlayStrategyHiLoRealisticSplitHandsTest extends HiLoRealisticStrategyTestHelper {
        ...
        for (Value upcardValue : Value.values()) {
            switch (upcardValue) {
                ...
                case Six:
                    ...
                    assertEquals(BlackjackPlay.Stand, compute(tc(5), cT(), cT(), c(upcardValue))); // don't deviate
                    assertEquals(BlackjackPlay.Stand, compute(tc(6), cT(), cT(), c(upcardValue))); // don't deviate
                    break;
                case Seven:
                case Eight:
                case Nine:
